...
class PriorityQueue:
    ...
    def update(self, item, priority):
        ...
        "*** YOUR MAY CODE HERE ***"
        # Check if item is already in the priority queue
        for i, (p, c, it) in enumerate(self.heap):
            if it == item:
                # If item is in the priority queue with a higher priority, update its priority and rebuild the heap.
                if p <= priority:
                    break
                del self.heap[i]
            ...
            # If item is not in the priority queue, add it with the given priority
